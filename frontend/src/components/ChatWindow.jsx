        ...
        <div className="flex items-start gap-2 md:gap-3 bg-gray-50 border-2 border-gray-300 rounded-xl md:rounded-2xl px-4 md:px-5 py-2 focus-within:border-gray-400 focus-within:ring-2 focus-within:ring-gray-400/20 transition-all duration-200 group hover:ring-2 hover:ring-gray-300/40">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0 pt-2">
            ...
            <button
              ...
              className="p-2 md:p-2.5 bg-purple-500 hover:bg-purple-600 text-white rounded-lg md:rounded-xl transition-all duration-200 flex-shrink-0 min-h-[40px] min-w-[40px] flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="p-2 md:p-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg md:rounded-xl transition-all duration-200 flex-shrink-0 min-h-[40px] min-w-[40px] flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
              title="Upload image"
            >
              <svg className="w-4 md:w-5 h-4 md:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <button
              ...
              disabled={loading}
              className="p-2 md:p-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg md:rounded-xl transition-all duration-200 flex-shrink-0 min-h-[40px] min-w-[40px] flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
              title="Upload PDF"
            >
